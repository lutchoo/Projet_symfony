 ...
 */
final class Version20231016145711 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE boardgame (id INT AUTO_INCREMENT NOT NULL, categorie_id INT NOT NULL, owner_id INT NOT NULL, name VARCHAR(100) NOT NULL, year_release INT NOT NULL, nbr_players INT NOT NULL, age_min INT NOT NULL, duration INT NOT NULL, img VARCHAR(100) NOT NULL, description LONGTEXT NOT NULL, INDEX IDX_98A1DB1DBCF5E72D (categorie_id), INDEX IDX_98A1DB1D7E3C61F9 (owner_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
